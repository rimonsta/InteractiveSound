...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 226.111106872558594, 248.9281005859375, 290.0, 22.0 ],
...
, 			{
				...
				"bootpath" : "~/Documents/InteractiveSound/InteractiveSound-RileyMeere",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
