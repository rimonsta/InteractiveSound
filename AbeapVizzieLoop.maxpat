...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 808.0, 641.0, 108.0, 78.0 ],
					"prototypename" : "pixl",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 943.0, 1227.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 858.0, 1009.0, 381.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 432.0, 895.0, 137.0, 116.0 ],
					"varname" : "bp.LFO",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "int" ],
					"patching_rect" : [ 638.0, 994.0, 133.0, 116.0 ],
					"varname" : "bp.MIDI In",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 47.0, 1203.0, 558.0, 223.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 654.0, 1310.0, 202.660293999999993, 116.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 873.0, 1304.0, 234.0, 116.0 ],
					"varname" : "bp.ADSR",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 697.0, 1639.0, 148.0, 116.0 ],
					"varname" : "bp.Stereo",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 654.0, 1454.0, 113.0, 116.0 ],
					"varname" : "bp.VCA",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 196.0, 1041.0, 314.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal" ],
					"patching_rect" : [ 682.0, 1169.0, 163.0, 116.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 774.0, 105.0, 53.0, 116.0 ],
					"varname" : "bp.Input",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 730.0, 819.0, 202.660293999999993, 116.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 359.0, 575.0, 178.0, 130.0 ],
					"varname" : "vz.modemixr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 637.0, 281.200012000000015, 108.0, 78.0 ],
					"prototypename" : "pixl",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 64.0, 771.0, 230.0, 208.0 ],
					"prototypename" : "pixl",
					"varname" : "viewr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 622.0, 594.0, 190.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.0, 335.200012000000015, 76.0, 23.0 ],
					"text" : "prepend op"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 261.5, 281.200012000000015, 60.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 185.5, 281.200012000000015, 60.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 109.5, 281.200012000000015, 60.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 33.5, 281.200012000000015, 60.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.0, 310.0, 247.0, 23.0 ],
					"text" : "pak * * * *"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 288.0, 428.0, 34.0, 22.0 ],
					"text" : "jit.op"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 595.0, 376.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 602.0, 419.0, 63.0, 22.0 ],
					"text" : "qmetro 40"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 595.0, 496.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 622.0, 552.0, 56.0, 22.0 ],
					"text" : "jit.catch~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 782.0, 473.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 774.0, 295.0, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 412.0, 365.0, 138.0, 130.0 ],
					"prototypename" : "pixl",
					"varname" : "freezr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 397.0, 751.0, 168.0, 108.0 ],
					"prototypename" : "pixl",
					"varname" : "projectr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 376.0, 223.0, 188.0, 130.0 ],
					"prototypename" : "pixl",
					"varname" : "foggr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 335.0, 42.0, 346.0, 158.0 ],
					"prototypename" : "pixl",
					"varname" : "grabbr",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-24::obj-20" : [ "ModWheelActivityLED", "ModWheelActivityLED", 0 ],
			"obj-24::obj-28" : [ "Bend", "Bend", 0 ],
			"obj-24::obj-69" : [ "1voctled", "1voctled", 0 ],
			...
			"obj-25::obj-53" : [ "Mute", "Mute", 0 ],
			"obj-28::obj-33" : [ "Quadrants", "Quadrants", 0 ],
			"obj-28::obj-55" : [ "Bypass", "Bypass", 0 ],
			"obj-28::obj-80" : [ "Response", "Response", 0 ],
			"obj-2::obj-29" : [ "range[5]", "range", 0 ],
			"obj-2::obj-31::obj-23" : [ "gswitch2[6]", "gswitch2", 0 ],
			"obj-2::obj-32::obj-23" : [ "gswitch2[5]", "gswitch2", 0 ],
			"obj-2::obj-36" : [ "pictctrl[14]", "pictctrl[1]", 0 ],
			"obj-2::obj-37" : [ "umenu[3]", "umenu", 0 ],
			"obj-2::obj-38" : [ "mix-amount", "Amount", 0 ],
			"obj-2::obj-51" : [ "pictctrl[13]", "pictctrl[1]", 0 ],
			...
			"obj-53::obj-11" : [ "Resonance", "Res", 0 ],
			"obj-53::obj-26" : [ "spectral", "spectral", 0 ],
			"obj-53::obj-51" : [ "CV2[1]", "CV2", 0 ],
			"obj-53::obj-54" : [ "CV1", "CV1", 0 ],
			"obj-53::obj-55" : [ "power", "power", 0 ],
			"obj-53::obj-59" : [ "filter_mode", "filter_mode", 0 ],
			"obj-53::obj-63" : [ "CV3[1]", "CV3", 0 ],
			"obj-53::obj-95" : [ "Freq[1]", "Freq", 0 ],
			"obj-53::obj-98" : [ "Gain[1]", "Gain", 0 ],
			"obj-54::obj-1" : [ "refresh", "refresh", 0 ],
			"obj-54::obj-12::obj-2" : [ "pastebang", "pastebang", 0 ],
			"obj-54::obj-9" : [ "MIDI_out_LED", "MIDI_out_LED", 0 ],
			"obj-55::obj-12" : [ "Mute[4]", "Mute", 0 ],
			"obj-55::obj-20" : [ "Frequency", "Freq", 0 ],
			"obj-57::obj-100" : [ "Offset[1]", "Offset", 0 ],
			"obj-57::obj-110" : [ "Wavetable", "Wavetable", 0 ],
			"obj-57::obj-12" : [ "Mute[5]", "Mute", 0 ],
			"obj-57::obj-154" : [ "CV2[2]", "CV2", 0 ],
			"obj-57::obj-25" : [ "WaveCV", "CV", 0 ],
			"obj-57::obj-3" : [ "Wave", "Wave", 0 ],
			"obj-57::obj-80" : [ "BankCV", "CV", 0 ],
			"obj-57::obj-81" : [ "Bank", "Bank", 0 ],
			"obj-75::obj-39" : [ "pictctrl[17]", "pictctrl[1]", 0 ],
			"obj-75::obj-6" : [ "pictctrl[16]", "pictctrl[1]", 0 ],
			"obj-75::obj-64" : [ "umenu[5]", "umenu", 0 ],
			"obj-9::obj-3" : [ "range[4]", "range", 0 ],
			"obj-9::obj-36" : [ "Probability", "Probability", 0 ],
			"obj-9::obj-37" : [ "X range", "X range", 0 ],
			"obj-9::obj-46" : [ "pictctrl[4]", "pictctrl[1]", 0 ],
			"obj-9::obj-47" : [ "pictctrl[3]", "pictctrl[1]", 0 ],
			"obj-9::obj-48" : [ "pictctrl[5]", "pictctrl[1]", 0 ],
